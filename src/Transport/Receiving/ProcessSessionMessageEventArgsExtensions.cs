...
static class ProcessSessionMessageEventArgsExtensions
{
    ...
    public static async ValueTask<bool> TrySafeAbandonMessage(this ProcessSessionMessageEventArgs args,
        ServiceBusReceivedMessage message, TransportTransactionMode transportTransactionMode,
        CancellationToken cancellationToken = default)
    {
    ...
    public static async Task SafeCompleteMessage(this ProcessSessionMessageEventArgs args,
        ServiceBusReceivedMessage message, TransportTransactionMode transportTransactionMode,
    ...
    public static async Task SafeAbandonMessage(this ProcessSessionMessageEventArgs args, ServiceBusReceivedMessage message,
