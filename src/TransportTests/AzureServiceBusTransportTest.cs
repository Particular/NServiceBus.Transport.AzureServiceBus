...
// Copy from Core and extended with ::CustomizeTransport

public abstract class AzureServiceBusTransportTest
{
    static AzureServiceBusTransportTest()
    {
    ...
    protected virtual void CustomizeTransport(TransportDefinition transport)
    {
    }
