...
//copy of the when_publishing test. The TF for Ordered Delivery CloudXP #713 noticed that the test took 18.2s to successfully complete when infrastructure was not created.
//But upon infrastructure creation, the test took 3s
//The original test from the sources has been excluded and a copy of it has been created here
public class When_publishing_test : NServiceBusAcceptanceTest
{
    [Test]
