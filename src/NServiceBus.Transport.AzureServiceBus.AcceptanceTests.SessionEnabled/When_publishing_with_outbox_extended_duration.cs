...
//copy of the When_publishing_with_outbox test.
//The TF for Ordered Delivery CloudXP #713 noticed that the test took 18s to complete successfully when infrastructure was not created and 3s when it was created.
//The original test from the sources has been excluded and a copy of it has been created here
public class When_publishing_with_outbox_extended_duration : NServiceBusAcceptanceTest
{
