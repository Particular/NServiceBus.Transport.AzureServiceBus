...
public class When_using_topic_per_event_topology_with_mapped_and_fallback_correlation_filter_on_shared_topic : NServiceBusAcceptanceTest
{
    static readonly string SharedTopicName = "MappedAndFallbackCorrelationFilterSharedTopic";
    ...
    public class Subscriber : EndpointConfigurationBuilder
    {
        public Subscriber() =>
            EndpointSetup<DefaultServer>(c =>
            {
                ...
                topology.SubscribeTo<IMyEvent>(SharedTopicName, options => options.Mode = TopicRoutingMode.CorrelationFilter);
