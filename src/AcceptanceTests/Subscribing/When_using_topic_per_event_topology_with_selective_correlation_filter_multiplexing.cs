...
public class When_using_topic_per_event_topology_with_selective_correlation_filter_multiplexing : NServiceBusAcceptanceTest
{
    static readonly string SharedTopicName = "SelectiveCorrelationFilterMultiplexing";
    ...
    public class Publisher : EndpointConfigurationBuilder
    {
        public Publisher() =>
            EndpointSetup<DefaultServer>(c =>
            {
                ...
                topology.PublishTo<MyEvent2>(SharedTopicName, options => options.Mode = TopicRoutingMode.CorrelationFilter);
