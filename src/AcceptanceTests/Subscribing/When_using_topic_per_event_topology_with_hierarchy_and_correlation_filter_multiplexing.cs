...
public class When_using_topic_per_event_topology_with_hierarchy_and_correlation_filter_multiplexing : NServiceBusAcceptanceTest
{
    static readonly string SharedTopicName = "HierarchyCorrelationFilterMultiplexing";
    ...
    [Test]
    public async Task Should_deliver_events_to_subscriptions_with_hierarchy_and_correlation_filter()
    {
