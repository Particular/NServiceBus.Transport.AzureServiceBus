...
This transport targets the Azure Service Bus .NET Standard client library using the [Microsoft.Azure.ServiceBus nuget package](https://www.nuget.org/packages/Microsoft.Azure.ServiceBus/).
